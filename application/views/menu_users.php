    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Menu Users</h1>
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Menu Users</li>
                </ol>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="card">
                    ...
                    <a class="m-0 float-right btn btn-danger btn-sm" 
                        href="<?php echo base_url('admin/user/add/') ?>">Tambah <i
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('admin/user/update/'.$value['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="<?php echo base_url('admin/user/delete/'.$value['id']) ?>" class="btn btn-sm btn-primary">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
